...
### FPS均为在设备<Jetson Orin Nano 4G>下使用TensorRT(8.6.2) FP16推理测速

| model | Input Shape | GFlops | Params | Ap | Ap50 | APs | APm | APl | FPS(Jetson Orin Nano 4G) |
| :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: | :----: |
...
| RTDETR-R18(Ultralytics版本实现) | (640, 640) | 57G | 19.885M | 0.208 | 0.363 | 0.113 | 0.305 | 0.413 | 28.3 |
| D-Fine-N | (640, 640) | 7.1238G | 3.73M | 0.183 | 0.334 | 0.093 | 0.270 | 0.442 | 53.5 |
| D-Fine-S | (640, 640) | 24.8595G | 10.18M | 0.227 | 0.394 | 0.128 | 0.331 | 0.468 | 29.9 |
| D-Fine-M | (640, 640) | 56.3726G | 19.19M | 0.239 | 0.416 | 0.136 | 0.346 | 0.464 | 18.2 |
...
| D-Fine-Dinov3(ConvNext-Tiny)-L | (640, 640) | 117.212G | 44.41M | 0.244 | 0.424 | 0.133 | 0.361 | 0.496 | 7.7 |
| D-Fine-Dinov3(ConvNext-Tiny)-L-4scale(P2345) | (640, 640) | 152.504G | 41.18M | 0.284 | 0.480 | 0.178 | 0.398 | 0.526 | - |
| DEIM-D-Fine-N | (640, 640) | 7.1238G | 3.73M | 0.177 | 0.322 | 0.090 | 0.262 | 0.376 | 53.5 |
| DEIM-D-Fine-S | (640, 640) | 24.8595G | 10.18M | 0.219 | 0.384 | 0.122 | 0.321 | 0.397 | 29.9 |
| DEIM-D-Fine-M | (640, 640) | 56.3726G | 19.19M | 0.242 | 0.417 | 0.139 | 0.344 | 0.485 | 18.2 |
| DEIMV2-S | (640, 640) | 25.3903G | 9.67M | 0.204 | 0.363 | 0.109 | 0.299 | 0.451 | 16.5 |
...
| YOLO11n | (640, 640) | 6.3G | 2.59M | 0.142 | 0.258 | 0.058 | 0.225 | 0.316 | 94.2 |
| YOLO11s | (640, 640) | 21.3G | 9.42M | 0.176 | 0.313 | 0.080 | 0.272 | 0.364 | 56.4 |
| YOLO11m | (640, 640) | 67.7G | 20.04M | 0.203 | 0.350 | 0.098 | 0.312 | 0.413 | 28.9 |
