...
7. 基于CVPR2025-DEIM的改进项目.(268¥,项目于20250330发布.)
    
    项目详细介绍请看[此处](https://github.com/z1069614715/objectdetection_script/blob/master/cvpr2025-deim-project.md)

8. 基于YOLO和RT-DETR的论文全流程指导项目.(原价258¥，若已购买yolo81011或rtdetr项目的则优惠70¥=188¥)[项目详解](https://github.com/z1069614715/objectdetection_script/blob/master/yolo-improve/paper.md)  
