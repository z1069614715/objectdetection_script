...
6. 基于Ultralytics的RT-DETR(CVPR2024)的剪枝蒸馏项目.
    ...
    剪枝：[项目详解](https://github.com/z1069614715/objectdetection_script/blob/master/yolo-improve/rtdetr-compress.md)(89.9¥)(目前还在开发中，预计在2025年一月完工)
    1. 模型轻量化,部署必备之一!
    2. 项目里面配套剪枝示例,并且都配有视频讲解,供大家理解如何进行蒸馏.
