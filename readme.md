...
2. 基于整合yolov8的项目.(69.9¥)
    ...
    4. 购买后进YOLOV8交流群(代码视频均在群公告),群里可交流代码和论文相关,目前2600+人,气氛活跃.
...
5. 基于YOLOV8的剪枝蒸馏项目.  
    注意:
    1. 目前只支持目标检测，不支持segment和pose，不是目标检测的先不用购买。
    2. 本次项目就直接提供几个文件，到时候会提供教程，自行复制到项目二上即可跑，原理上其他版本应该也可以跑，但是开发的时候我是基于项目二的8.0.202上开发的，附近的版本的话应该也可以跑，但是没办法一一验证，所以需自行考虑!
    3. 里面会提供一个官方纯净版的8.0.202的v8，以便没有购买项目二的同学使用。
    ...
    蒸馏:[项目详解](https://github.com/z1069614715/objectdetection_script/blob/master/yolo-improve/yolov8-distill.md)(89.9¥,目前优惠期(2024/1/2~2024/1/28),购买过项目二、项目三、项目五的剪枝各优惠10,最多叠加2次,项目最迟2024/1/14发布)
    1. 模型轻量化,部署必备之一!
