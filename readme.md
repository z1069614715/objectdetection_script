...
7. 基于CVPR2025-DEIM的改进项目.(268¥)
    
    项目详细介绍请看[此处](https://github.com/z1069614715/objectdetection_script/blob/master/cvpr2025-deim-project.md)

8. 基于YOLO和RT-DETR的论文全流程指导项目.(原价258¥，若已购买yolo8101112或rtdetr项目的则优惠70¥=188¥)[项目详解](https://github.com/z1069614715/objectdetection_script/blob/master/yolo-improve/paper.md)  
    ...
    11. 项目公开课试听B站链接4：[长达2小时的论文高效画图专题全面剖析：数据可视化+模型图绘制+实验数据分析图+答疑直播，全程高能！！！！](https://www.bilibili.com/video/BV1xEEEzZEUs)
