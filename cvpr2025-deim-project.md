...
5. 本项目会包含模型剪枝和模型蒸馏，不需要再额外购入，所以性价比真的非常高，YOLO改进剪枝蒸馏三件套也要200多了。
...
- 20260924
    ...
    1. 新增基于gradio开发的可视化界面，支持目标检测、实例分割、旋转目标检测任务，并支持单模态、图图多模态、图文多模态、图图文多模态任务识别。
    2. 新增text-encoder(SigLIP2和PE-Core)。
    3. 新增论文视频-实验设计的7个亮点。
